...
(function ($) {
  ...
  SEMICOLON.initialize = {
    ...
    scrollToEnroll: function () {
      document.querySelector('#enroll').scrollIntoView({
        behavior: 'smooth',
      });
    },
  ...
  SEMICOLON.header = {
    ...
    initialize: function () {
      ...
      $('.menu-item:not(.mega-menu-title):has(.sub-menu-container):not(:has(.sub-menu-trigger))').append(
